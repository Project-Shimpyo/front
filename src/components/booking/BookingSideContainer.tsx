...
export default function BookingSideContainer() {
  return (
    <Container>
      ...
      <Title borderTop={true}>할인</Title>
      <Detail>1. 당일예약의 경우 입실시간 전에 한하여 90% 환불 받으실 수 있습니다.</Detail>

      <Title borderTop={true}>환불 정책</Title>
      <Detail>1. 당일예약의 경우 입실시간 전에 한하여 90% 환불 받으실 수 있습니다.</Detail>
      <Detail>2. 당일예약이 아닐 경우 입실시간 전에 한하여 100% 환불 받으실 수 있습니다.</Detail>
      <Detail>3. 입실시간을 초과하실 시 환불을 받으실 수 없습니다.</Detail>
      <Title borderTop={true}>기본 규칙</Title>
      <Detail>
        훌륭한 게스트가 되기 위한 몇 가지 간단한 규칙을 지켜주실 것을 모든 게스트에게 당부드리고 있습니다.
        <BasicRule>
          <li>
            <BsDot /> 숙소 이용규칙을 준수하세요.
          </li>
          <li>
            <BsDot /> 호스트의 집도 자신의 집처럼 아껴주세요.
          </li>
        </BasicRule>
      </Detail>
      <NoticeBox>
      ...
      <FinalNotice>
        ...
        <span style={{ textDecoration: 'underline', fontWeight: '600' }}>
          호스트가 설정한 숙소 이용규칙, 게스트에게 적용되는 기본 규칙, 에어비앤비 재예약 및 환불 정책
        </span>
        에 동의하며, 피해에 대한 책임이 본인에게 있을 경우 에어비앤비가
        <span style={{ textDecoration: 'underline', fontWeight: '600' }}>결제 수단으로 청구</span>의 조치를 취할 수
